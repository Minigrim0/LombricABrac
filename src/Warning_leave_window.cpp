...
info Warning_leave_window::run(info information)
{
  ...
  int i;
  string msg1 = "Voulez-vous vraiment retourner à l'écran titre ?";
...
int Warning_leave_window::envoyer_info_client()
{
  return 0;
}

int Warning_leave_window::recevoir_info_client()
{
  return 0;
}
