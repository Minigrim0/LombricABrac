...
void Client::notifyStarted(message& m){ //serveur nevoie message quand la partie démarre
	...
	for (int i=0;i<obj.lomb_size();i++){
		gameInfo->spriteVector.push_back(new Lombric_c(obj.lomb(i).id_lomb(),obj.lomb(i).team_lomb()-1, obj.lomb(i).pos_x(), obj.lomb(i).pos_y(), '0'+ obj.lomb(i).team_lomb(),100,150, obj.lomb(i).name_lomb()));
